...
resolve to this standard Blues/navy family regardless of what hue that measure ends
up using. Blues is simply the **default/standard hue for branding surfaces
specifically** — not a harmonization step that adapts per table, and not something
a heatmap's own hue ever overrides.
